      ...
      <div className="row g-3 d-flex justify-content-center">
        <div className="col-sm-8 color__area">
          <div className="form-group pt-3">
            <textarea style={{ backgroundColor: `${colorName}` }} type="text" className="form-control" placeholder="Here, you will see your color area..." id="colorTextarea" rows="6"></textarea>
          ...
          <div className="form-group pt-3">
            ...
            <input type="text" className="form-control" id="ColorCodeInput" placeholder="Write here color code or, name ..." onChange={(e) => setColorName(e.target.value)} />
          </div>
        </div>
      </div>
    </div>
